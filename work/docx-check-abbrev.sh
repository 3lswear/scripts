...
Проверяет документ на наличие ненужных сокращений из перечня. В конце выводится
количество упоминаний каждого сокращения из перечня в документе. Если оно 1, то
сокращение упоминается только в перечне, и, следовательно, его можно удалить.
"
    exit
fi
